...
# Note: Uncomment the following line to save images
...
vision_model = ChatOllama(
    model="llava:7b",  # Replace with the name of the locally available Ollama model
    temperature=0.0
)
...
# For this script and available dataset, we will use the following query:
# query = "pink flower with yellow center"  # Change this to test different queries

# For testing purposes, we will use the above query
